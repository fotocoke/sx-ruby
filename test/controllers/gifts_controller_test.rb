...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { description: @gift.description, gift_link_id: @gift.gift_link_id, title: @gift.title } }, as: :json
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { description: @gift.description, gift_link_id: @gift.gift_link_id, title: @gift.title } }, as: :json
    assert_response 200
  end
